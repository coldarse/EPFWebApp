...
VerifyMyKadComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({ type: VerifyMyKadComponent, selectors: [["app-verify-my-kad"]], decls: 10, vars: 8, consts: [[1, "bg-img", 2, "background", "url('assets/images/BG.png') no-repeat scroll right center"], ["class", "header", 4, "ngIf"], [1, "container-fluid"], ["class", "row padTop10rem", 4, "ngIf"], ["class", "row padTop25rem", 4, "ngIf"], [1, "header"], [1, "row", "padTop10rem"], [1, "text-center"], [1, "lblHeader"], [1, "row", "padTop3rem"], ["src", "assets/images/insert-mykad.svg", "width", "800px", "height", "800px"], [1, "row", "padTop25rem"], [1, "row"], [1, "col-6"], ["type", "button", 1, "btnShariah", 3, "click"], ["src", "assets/images/thumbprint.svg", "width", "800px", "height", "800px"], [1, "col-3"], ["type", "button", 1, "btnNo", 3, "click"], [1, "row", "padTop5rem"], [1, "col-2"], [1, "col-8", "lblRemove"], ["src", "assets/images/remove-mykad.svg", "width", "800px", "height", "800px"]], template: function VerifyMyKadComponent_Template(rf, ctx) { if (rf & 1) {
