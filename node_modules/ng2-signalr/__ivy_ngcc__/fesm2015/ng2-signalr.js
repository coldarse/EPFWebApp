...
SignalR.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: SignalR, factory: SignalR.ɵfac });
SignalR.ctorParameters = () => [
    { type: SignalRConfiguration },
    { type: NgZone },
    { type: undefined, decorators: [{ type: Inject, args: [SIGNALR_JCONNECTION_TOKEN,] }] }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(SignalR, [{
        type: Injectable
    }], function () { return [{ type: SignalRConfiguration }, { type: ɵngcc0.NgZone }, { type: undefined, decorators: [{
                type: Inject,
...
SignalRModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ providers: [{
            provide: SignalR,
            useValue: ɵ0
        }] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(SignalRModule, [{
        type: NgModule,
        args: [{
                providers: [{
                        provide: SignalR,
